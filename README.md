...
* `v1.10.2`, `latest`    [(v1.10.2/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.10.2/Dockerfile)
* `v1.9.7`,     [(v1.9.7/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.9.7/Dockerfile)
