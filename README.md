...
* `v1.24.3`, `latest`    [(v1.24.3/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.24.3/Dockerfile)
* `v1.23.9`,    [(v1.23.9/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.23.9/Dockerfile)
* `v1.22.12`,    [(v1.22.12/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.22.12/Dockerfile)
