...
* `v1.18.4`, `latest`    [(v1.18.4/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.18.4/Dockerfile)
* `v1.17.7`,    [(v1.17.7/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.17.7/Dockerfile)
* `v1.16.11`,    [(v1.16.11/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.16.11/Dockerfile)
