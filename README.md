...
* `v1.7.2`, `latest`    [(v1.7.2/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.7.2/Dockerfile)
* `v1.6.7`,     [(v1.6.7/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.6.7/Dockerfile)
