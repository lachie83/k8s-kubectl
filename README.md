...
* `v1.13.4`, `latest`    [(v1.13.4/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.13.4/Dockerfile)
* `v1.12.5`,    [(v1.12.5/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.12.5/Dockerfile)
