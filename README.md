...
* `v1.19.3`, `latest`    [(v1.19.3/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.19.3/Dockerfile)
* `v1.18.10`,    [(v1.18.10/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.18.10/Dockerfile)
* `v1.17.13`,   [(v1.17.13/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.17.13/Dockerfile)
