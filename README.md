...
* `v1.9.0`, `latest`    [(v1.9.0/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.9.0/Dockerfile)
* `v1.8.6`, `latest`    [(v1.8.6/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.8.6/Dockerfile)
* `v1.7.10`,     [(v1.7.10/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.7.10/Dockerfile)
