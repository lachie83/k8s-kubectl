...
* `v1.23.9`, `latest`    [(v1.23.9/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.23.9/Dockerfile)
* `v1.22.9`,    [(v1.22.9/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.22.9/Dockerfile)
