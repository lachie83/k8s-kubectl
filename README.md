...
* `1.5.0`, `latest`    [(1.5.0/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.5.0/Dockerfile)
* `1.4.7`,     [(1.4.7/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.4.7/Dockerfile)
