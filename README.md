...
* `v1.14.3`, `latest`    [(v1.14.3/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.14.3/Dockerfile)
* `v1.13.7`,    [(v1.13.7/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.13.7/Dockerfile)
* `v1.12.7`,    [(v1.12.7/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.12.7/Dockerfile)
