...
* `v1.16.2`, `latest`    [(v1.16.2/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.16.2/Dockerfile)
* `v1.15.5`,    [(v1.15.5/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.15.5/Dockerfile)
* `v1.14.8`,    [(v1.14.8/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.14.8/Dockerfile)
