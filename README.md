...
* `v1.6.1`, `latest`    [(v1.6.1/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.6.1/Dockerfile)
* `v1.5.5`,     [(v1.5.5/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.5.5/Dockerfile)
