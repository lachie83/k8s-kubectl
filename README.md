...
* `v1.18.5`, `latest`    [(v1.18.5/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.18.5/Dockerfile)
* `v1.17.8`,    [(v1.17.8/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.17.8/Dockerfile)
* `v1.16.12`,    [(v1.16.12/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.16.12/Dockerfile)
