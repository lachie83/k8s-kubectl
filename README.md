...
* `v1.12.2`, `latest`    [(v1.12.2/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.12.2/Dockerfile)
* `v1.11.4`,    [(v1.11.4/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.11.4/Dockerfile)
