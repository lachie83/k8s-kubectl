...
* `v1.10.0`, `latest`    [(v1.10.0/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.10.0/Dockerfile)
* `v1.9.6`,     [(v1.9.6/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.9.6/Dockerfile)
* `v1.8.10`,    [(v1.8.10/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.8.10/Dockerfile)
* `v1.7.15`     [(v1.7.15/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.7.15/Dockerfile)
