...
* `v1.18.2`, `latest`    [(v1.18.2/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.18.2/Dockerfile)
* `v1.17.5`,    [(v1.17.5/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.17.5/Dockerfile)
