...
* `v1.16.5`,    [(v1.16.5/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.16.5/Dockerfile)
* `v1.15.8`,    [(v1.15.8/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.15.8/Dockerfile)
