...
* `v1.8.1`, `latest`    [(v1.8.1/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.8.1/Dockerfile)
* `v1.7.9`,     [(v1.7.9/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.7.9/Dockerfile)
