...
* `v1.18.6`, `latest`    [(v1.18.6/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.18.6/Dockerfile)
* `v1.17.9`,    [(v1.17.9/Dockerfile)](https://github.com/lachie83/k8s-kubectl/blob/v1.17.9/Dockerfile)
